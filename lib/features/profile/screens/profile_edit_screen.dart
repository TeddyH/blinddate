    ...
    try {
      ...
      if (profile != null) {
        ...
        setState(() {
          ...
          _personalityTraits = List<String>.from(profile['personality_traits'] ?? []);
          _othersSayAboutMe = List<String>.from(profile['others_say_about_me'] ?? []);
          _idealTypeTraits = List<String>.from(profile['ideal_type_traits'] ?? []);
  ...
  Future<void> _saveProfile() async {
    ...
    try {
      ...
      await authService.updateUserProfile({
        ...
        'rejection_reason': _currentApprovalStatus == AppConstants.approvalApproved ? null : null,
    ...
    return ProfileSectionCard(
      ...
      child: Column(
        ...
        children: [
          ...
          // Gender and Birth Year (Read-only in edit mode)
          Row(
            children: [
              Expanded(
                flex: 2,
                    ...
                    Container(
                      ...
                      child: Text(
                        _selectedBirthYear != null
                            ? '$_selectedBirthYear년 (${DateTime.now().year - _selectedBirthYear!}세)'
                            : '',
                        style: const TextStyle(
                          color: Colors.white54,
                          fontSize: 16,
