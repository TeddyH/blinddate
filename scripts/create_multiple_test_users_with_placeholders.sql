-- 여러 테스트 사용자 생성 및 placeholder 이미지 할당
...
INSERT INTO blinddate_users (
    ...
    'approved',
    ARRAY['https://via.placeholder.com/400x400/FF69B4/FFFFFF?text=Snow'],
    'female'
);
...
INSERT INTO blinddate_users (
    ...
    'approved',
    ARRAY['https://via.placeholder.com/400x400/4A90E2/FFFFFF?text=MultiShot'],
    'male'
);
...
INSERT INTO blinddate_users (
    ...
    'approved',
    ARRAY['https://via.placeholder.com/400x400/32CD32/FFFFFF?text=FastBoots'],
    'female'
);
...
INSERT INTO blinddate_users (
    ...
    'approved',
    ARRAY['https://via.placeholder.com/400x400/FF6347/FFFFFF?text=FastShot'],
    'male'
);
...
SELECT
    ...
    profile_image_urls[1] as image_url
