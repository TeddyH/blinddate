...
SELECT
    ...
    match_date::text as date_info,
    status,
    user1_id::text as user1,
    user2_id::text as user2,
    reveal_time::text as reveal,
    revealed_at::text as revealed
...
SELECT
    ...
    process_date::text as date_info,
    status,
    NULL as user1,
    NULL as user2,
    NULL as reveal,
